...
if (is_admin()) {
    $basename_excludes = array('plugins.php', 'plugin-install.php', 'plugin-editor.php', 'themes.php', 'theme-install.php', 
        'theme-editor.php', 'tools.php', 'import.php', 'export.php');
...
?>
<style type="text/css">
    .mce-container.mce-panel.mce-floatpanel{z-index: 100000!important}
